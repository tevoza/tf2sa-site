...
$db = $data->getDbCon();
$q="
SELECT Players.PlayerName Player, COUNT(DISTINCT GameID) Matches, SUM(Playtime)/3600 Time, SUM(PlayerStats.Damage) TotalDamage,AVG(Damage)/AVG(Playtime)*60 DPM
